...
- Precision voltage monitor monitor provides a low-voltage replica of the measured electrostatic voltage for external monitoring purposes, or for use as a feedback signal in a closed-loop system
...
|---|---|---|
|Measurement Range|0 to ±3 kVDC or peak AC| |
|Accuracy|Voltage Monitor: Better than ±0.05% of full scale| |
| |Voltage Display: Better than ±0.1% of full scale ±1 count, referred to the voltage monitor.| |
|Speed of Response|Less than 50 ms for a 1 kV step (10 to 90%)| |
|Stability|Drift with Time: Less than 150 ppm/hour, noncumulative| |
...
|Compliance|Overvoltage Category CAT II: Local-level mains, appliances, portable equipment| | |
| |Pollution Category Degree 1: Operate in environments where no pollution or only dry, nonconductive pollution occurs.| | |
...
|Reference Number|Description|Line Voltage| |
|---|---|---|---|
|370-1|Electrostatic Voltmeter with 1/100 Monitor Output Ratio|90 to 127 VAC|180 to 250 VAC|
|370-2|Electrostatic Voltmeter with 1/200 Monitor Output Ratio|90 to 127 VAC|180 to 250 VAC|
|370-3|Electrostatic Voltmeter with 1/300 Monitor Output Ratio|90 to 127 VAC|180 to 250 VAC|
|370-6|Electrostatic Voltmeter with 1/600 Monitor Output Ratio|90 to 127 VAC|180 to 250 VAC|
|370-10|Electrostatic Voltmeter with 1/1000 Monitor Output Ratio|90 to 127 VAC|180 to 250 VAC|
