...
|A1-A9|POWER GND|B1-B9|POWER GND|
|---|---|---|---|
|A10-18|+12V|B10-B18|+12V|
|A19|SDA|B19|A0 (addressing)|
|A20|SCL|B20|A1 (addressing)|
|A21|PSON#|B21|12VSB|
|A22|SMBAlert#|B22|CR_BUS|
|A23|RETURN_SENSE|B23|ISHARE|
|A24|+12V_REMOTE_SENSE|B24|GND (used by system for presence detect)|

# ADDRESSING

|PMBUS| | |IPMI FRU|
|---|---|---|---|
|A1|A0|Write Address|Read Address|
|0|0|B0h|B1h|
|0|1|B2h|B3h|
|1|0|B4h|B5h|
|1|1|B6h|B7h|
