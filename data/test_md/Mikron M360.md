...
- Highly mobile with weight of only 17.8 kg (39.3 lb)
- High accuracy ±0.2% of reading ±1°C
- High resolution, high emissivity 1.0 effective @ 0.7 to 1.8 μm T ≥ 230°C, 1.0 @ 8 to 14 μm T < 230°C
...
|Standard:|Radiometric (pyrometric)|
|---|---|
|Thermocouple| |
|Warm-up Time|60 minutes from ambient to 700°C|
|Slew Rate to 1°C Stability|~11°C / min for Amb < T < 200°C ~20°C / min for Amb < T < 800°C ~10°C / min for T > 900°C|
