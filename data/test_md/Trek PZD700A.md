...
|---|---|
| |Unipolar: 0 to +1.4 kV DC or peak AC or 0 to -1.4 kV DC or peak AC|
|Output Current Range|Bipolar: 0 to ±100 mA|
| |Unipolar: 0 to ±50 mA|
...
|---|---|---|
|Output Voltage Range|0 to ±700 VDC or peak AC|0 to +1.4 kV DC or 0 to -1.4 kV DC or peak AC|
|Output Current Range|0 to ±100 mA|0 to ±50 mA|
...
Output Noise:
- Less than 50 mV rms to 20 kHz for a 1 nF load
- Less than 100 mV rms to 20 kHz with no load

Slew Rate:
- Greater than 380 V/μs (10% to 90%, typical)
- Greater than 370 V/μs (10% to 90%, typical)
...
An amber indicator warns when the Trek PZD700A fails to produce the required HV output

Automatic Power Limit

Automatically limits the internal power dissipation to protect the Trek PZD700A from overheating
