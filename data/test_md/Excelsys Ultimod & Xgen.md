...
|Model|Vnom (V)|Set Point Adjust Range (V)|Dynamic Vtrim Range (V)|Imax (A)|Power (W)|Capacitive Loading (mF)|Remote Sense|Power Good|
|---|---|---|---|---|---|---|---|---|
...
The output powerMods connection details are shown below. Type A connectors are for single output powerMods XgA-XgT and Xg1-Xg7. The Type B connector is for the dual output XgF/Xg8 powerMod. The power and signal connectors are as follows:

|Pin|J3 (XgA-XgD)|J3 (XgG-XgQ)|J3 (XgR-XgT)|J3 (XgE)|J3 (XgF)|J4 (Type A)|J4 (Type B)|
|---|---|---|---|---|---|---|---|
|1|not used|+Sense|not used|not used|-pg (V2)|-Vout|-Vout 2|
|2|Common|-Sense|-Vtrim|not used|+pg (V2)|+Vout|+Vout 2|
|3|not used|Vtrim|+Vtrim|not used|Inhibit V2|—|-Vout 1|
|4|not used|Itrim|Itrim|Common|Common (V2)|—|+Vout 1|
...
- J3: Locking Molex 51110-0860; Non Locking Molex 51110-0850; Crimp Terminal: Molex p/n 50394. Or Molex 51110-0856, includes locking tab and polarization keying
- J4 (Type A): M4 screw (8 mm) Max Torque 0.74 Nm
- J4 (Type B) Connector(s): Camden CTB9200/4A or Wurth Elektronik 691 352 710 004

|Type A|Type B|
|---|---|
|8 J37|8 J37|
|V1 Adjust|Type A: powerMods XgA to XgE|
|Voltage Adjust|Type B: powerMod XgF/Xg8|
|V2 Adjust|—|
|2 1|2 1|
...
Temperature Derating CurveUX6
---
# ULTIMOD SERIES

MECHANICAL DRAWINGS

|UX4|46.00|2206|92.00|
|---|---|---|---|
|23.50| | | |
|4-OFF MA Mounting Holes on the Base| | | |
|42.0000 +|Max Screw penetration is 6mm from Base| | |
|TOP VIEW| | | |
|23.50| | | |
|89.00|22|SLOT D| |
|23.50| | | |
...
|---|---|---|---|---|---|
|23.50| | | | | |
| |4.00|4-OFF M4 Mounting Holes on the Base| | | |
|Max Screw penetration is 8mm from Base| | | | | |
| | |TOP VIEW| | | |
|23.50| | | | | |
|83.00| |22|SLOT F| | |
|23.50| | | | | |
...
|---|---|---|---|---|---|
|powerMods| |Standard| |Input Connector Option| |
|e.g. A for XgA| |Conformal coating|0 = IEC| | |
|B for XgB| |P = Factory preset| |D = Flying Lead| |
| |0 for Empty Slot|R = RuggedisedRuggedised and Conformal Coating| | | |
...
productsupport.ep@aei.com (Technical Support) Specifications are subject to change without notice. Not responsible for errors or omissions. ©2024 Advanced Energy Industries, Inc. All rights reserved. Advanced Energy®, and AE® are U.S. trademarks of Advanced Energy Industries, Inc.

ENG-LV_ULTIMOD-235-08 05.22.24