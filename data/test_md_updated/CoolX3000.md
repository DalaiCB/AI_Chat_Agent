...
|Overtemperature Protection|Conditions/Description|Min|Nom|Max|Units|
|---|---|---|---|---|---|
|Autorecovery| |—|—|—| |
...
*For reverse polarity mode, a shunting header must be placed on each CX18 comms board to short J1011 pin 1 to 2.
